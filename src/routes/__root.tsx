...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "PLATFORM.TJ" },
      { title: "PLATFORM.TJ — Управление застройкой" },
      { name: "description", content: "ERP/CRM для строительных компаний: проекты, продажи квартир, платежи и расходы." },
      { property: "og:title", content: "PLATFORM.TJ — Управление застройкой" },
      { name: "twitter:title", content: "PLATFORM.TJ — Управление застройкой" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "PLATFORM.TJ",
          url: "https://platform.tj",
          logo: "https://platform.tj/icon-192.png",
