...
export const Route = createFileRoute("/p/$id")({
  head: ({ params }) => ({
    meta: [
      ...
      { property: "og:url", content: `https://platform.tj/p/${params.id}` },
      { property: "og:type", content: "product" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [{ rel: "canonical", href: `https://platform.tj/p/${params.id}` }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          url: `https://platform.tj/p/${params.id}`,
          brand: { "@type": "Brand", name: "PLATFORM.TJ" },
        }),
      },
    ],
  }),
